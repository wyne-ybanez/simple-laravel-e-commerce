    ...
    <div class="bg-white p-4 rounded border animate-fade-in">
      <div class="flex justify-between pb-5">
        <div class="flex items-center">
          ...
          <span class="ml-3">{{ orders.total }}</span>
        </div>
        <!-- Search -->
        <div>
      ...
      <table class="table-auto w-full">
        <thead class="text-left">
          <tr>
            <TableHeaderCell @click="sortOrders('id')" class="border-b p-2 pb-5 font-medium" field="id" :sort-field="sortField" :sort-direction="sortDirection">
              ID
            </TableHeaderCell>
            <TableHeaderCell class="border-b p-2 pb-5 font-medium" :sort-field="sortField" :sort-direction="sortDirection">
              Customer
            </TableHeaderCell>
            <TableHeaderCell @click="sortOrders('status')" class="border-b p-2 pb-5 font-medium" field="status" :sort-field="sortField" :sort-direction="sortDirection">
              Status
            </TableHeaderCell>
            <TableHeaderCell @click="sortOrders('total_price')" class="border-b p-2 pb-5 font-medium" field="price" :sort-field="sortField" :sort-direction="sortDirection">
              Price
            </TableHeaderCell>
            <TableHeaderCell @click="sortOrders('created_at')" class="border-b p-2 pb-5 font-medium" field="category" :sort-field="sortField" :sort-direction="sortDirection">
              Date
            </TableHeaderCell>
            <TableHeaderCell field="actions" class="border-b p-2 pb-5 font-medium">
              Actions
            </TableHeaderCell>
          </tr>
        </thead>
        ...
        <tbody v-if="!orders.loading" class="font-light">
          ...
          <tr v-for="(order, index) of orders.data" class="animate-fade-in">
            ...
            <td class="border-b p-2 ">
                <router-link :to="{name: 'app.orders.view', params: {id: order.id}}"
                            class="w-8 h-8 rounded-full text-stone-700 border border-stone-700 flex justify-center items-center
