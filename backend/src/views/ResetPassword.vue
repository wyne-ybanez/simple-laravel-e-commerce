        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input id="new-password" name="password" type="password" required=""
              class="
                relative block w-full appearance-none rounded-none rounded
                border border-gray-300 px-3 py-2 mb-8 text-gray-900 placeholder-gray-500
          ...
          <div>
            ...
            <input id="password-repeat" name="password_repeat" type="password" required=""
              class="
                relative block w-full appearance-none rounded-none rounded border
