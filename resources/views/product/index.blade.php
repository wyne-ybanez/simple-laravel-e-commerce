    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 p-5">
        ...
        <div x-data="productItem({{ json_encode([
            ...
            <div class="flex justify-end items-end pb-5 px-4 mt-auto">
                ...
                <div class="flex">
                    <button @click="addToWatchlist()" class="w-10 h-10 mr-2 rounded-sm border border-2 border-bg-strong flex items-center justify-center hover:bg-stone-600 hover:border-stone-600 hover:text-white active:bg-stone-800 transition-colors" :class="isInWatchlist(id) ? 'bg-stone-600 text-white' : 'text-strong'">
