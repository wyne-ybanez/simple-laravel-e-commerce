<div class="container">
    <div class="grid w-screen grid-cols-1 lg:grid-cols-2 bg-strong text-black py-20 gap-16 lg:gap-0">
        ...
        <div class="lg:col-span-1 xl:my-24 lg:px-20 lg:pl-0">
            <div x-data="{
                ...
                <div class="relative">
                    <img :src="activeImage ? activeImage : image[0]" alt="" class="w-full shadow shadow-xl shadow-white cursor-pointer grayscale rounded" :class="grayscale ? 'grayscale' : 'grayscale-0'" @click="grayscale = !grayscale" />
                </div>
