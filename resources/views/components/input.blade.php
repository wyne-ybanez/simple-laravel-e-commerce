@props(['disabled' => false, 'type' => 'text', 'errors', 'type' => 'text', 'label' => false])
...
<div>
    ...
    <select {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
        'class' => 'border-gray-300 focus:border-stone-500 focus:outline-none focus:ring-stone-500 rounded-md w-full ' .
