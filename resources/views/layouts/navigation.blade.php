<header x-data="{ mobileMenuOpen: false }" class="flex justify-between border-b border-bg-soft sticky top-0 z-50 bg-primary">
        ...
        <ul>
            ...
            <li>
                <a href="/src/cart.html" class="relative flex items-center justify-between py-3 px-6 transition-colors hover:bg-gray-100">
                    ...
                    <!-- Cart Items Counter -->
                    <small x-show="cartItemsCount" x-transition x-text="cartItemsCount" x-cloak class="py-[2px] px-[8px] rounded-full bg-orange-800">
                    </small>
                    <!--/ Cart Items Counter -->
                </a>
            </li>
    ...
    <nav class="hidden md:block text-stone-600">
        <ul class="grid grid-flow-col items-center">
            ...
            <li>
                <a href="{{ route('cart') }}" class="relative inline-flex items-center py-navbar-item px-navbar-item hover:text-primary">
                    <div class="link-underline link-underline-black">
            ...
            <li x-data="{open: false}" class="relative">
                ...
                <ul @click.outside="open = false" x-show="open" x-transition x-cloak class="rounded-sm shadow-md absolute z-10 right-0 bg-white py-2 w-48">
                    ...
                    <li>
                        <a href="/src/watchlist.html" class="flex w-full px-5 py-2 hover:bg-gray-100">
                            <div class="flex items-center">
                                Watchlist
                            </div>
                            <small x-show="$store.header.watchlistItems" x-transition x-text="$store.header.watchlistItems" class="py-[2px] px-[8px] rounded-full bg-orange-800"></small>
