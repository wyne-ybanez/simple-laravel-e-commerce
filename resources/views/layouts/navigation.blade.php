<header
    ...
    class="flex justify-between border-b border-bg-soft sticky top-0 z-50 bg-primary"
>
    <div>
            ...
            <li>
                <a href="{{ route('cart.index') }}" class="relative inline-flex items-center py-navbar-item px-navbar-item hover:text-primary">
                    ...
                    <small 
                        ...
                        x-cloak 
                        x-text="cartItemsCount" 
                        class="absolute z-[100] top-4 right-4 py-[2px] px-[8px] rounded-full text-white bg-stone-700"
                    >
                    </small>
